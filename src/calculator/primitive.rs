...
impl Primitive {
    pub fn as_ref_ok(&self) -> anyhow::Result<&Primitive> {
        match self {
            Primitive::Int(_) | Primitive::Bool(_) | Primitive::Double(_)  => Ok(self),
            Primitive::Error(msg) => Err(anyhow::Error::msg(msg.clone())),
        }
    }
    pub fn ok(self) -> anyhow::Result<Primitive> {
        match self {
            Primitive::Int(_) | Primitive::Bool(_) | Primitive::Double(_)  => Ok(self),
            Primitive::Error(msg) => Err(anyhow::Error::msg(msg.clone())),
        }
...
impl Sin for Primitive {
    fn sin(&self) -> Self {
        match self {
            ...
            Primitive::Bool(_b) => Primitive::Error("call to sin() on a boolean value"),
...
impl Cos for Primitive {
    fn cos(&self) -> Self {
        match self {
            ...
            Primitive::Bool(_b) => Primitive::Error("call to cos() on a boolean value"),
...
impl Tan for Primitive {
    fn tan(&self) -> Self {
        match self {
            ...
            Primitive::Bool(_b) => Primitive::Error("call to tan() on a boolean value"),
...
impl Logarithm for Primitive {
    fn log(&self) -> Self {
        match self {
            ...
            Primitive::Bool(_b) => Primitive::Error("call to log tan() on a boolean value"),
    ...
    fn ln(&self) -> Self {
        match self {
            ...
            Primitive::Bool(_b) => Primitive::Error("call to ln() on a boolean value"),
...
impl Sqrt for Primitive {
    fn sqrt(&self) -> Self {
        match self {
            ...
            Primitive::Bool(_b) => Primitive::Error("call to sqrt() on a boolean value"),
...
impl Abs for Primitive {
    fn abs(&self) -> Self {
        match self {
            ...
            Primitive::Bool(_b) => Primitive::Error("call to abs() on a boolean value"),
    ...
    fn pow(&self, rhs: Self) -> Self {
        match self {
            Primitive::Int(l) => match rhs {
                ...
                Primitive::Int(r) => Primitive::Double((*l as f64).powf(r as f64)),
                Primitive::Double(r) => Primitive::Double((*l as f64).powf(r)),
                Primitive::Bool(_b) => Primitive::Error("call to pow() on a boolean value"),
    ...
    fn add(self, rhs: Self) -> Self::Output {
        match self {
            Primitive::Int(l) => match rhs {
                ...
                Primitive::Bool(_b) => Primitive::Error("call to add() on a boolean value"),
    ...
    fn sub(self, rhs: Self) -> Self::Output {
        match self {
            Primitive::Int(l) => match rhs {
                Primitive::Int(r) => Primitive::Int(l - r),
                Primitive::Double(r) => Primitive::Double(l as f64 - r),
                Primitive::Bool(_b) => Primitive::Error("call to sub() on a boolean value"),
    ...
    fn rem(self, rhs: Self) -> Self::Output {
        match self {
            Primitive::Int(l) => match rhs {
                ...
                Primitive::Double(r) => Primitive::Double(l as f64 % r),
                Primitive::Bool(_b) => Primitive::Error("call to rem() on a boolean value"),
    ...
    fn mul(self, rhs: Self) -> Self::Output {
        match self {
            Primitive::Int(l) => match rhs {
                Primitive::Int(r) => Primitive::Int(l * r),
                Primitive::Double(r) => Primitive::Double(l as f64 * r),
                Primitive::Bool(_b) => Primitive::Error("call to mul() on a boolean value"),
    ...
    fn div(self, rhs: Self) -> Self::Output {
        match self {
            Primitive::Int(l) => match rhs {
                ...
                Primitive::Bool(_b) => Primitive::Error("call to div() on a boolean value"),
...
impl std::ops::Neg for Primitive {
    ...
    fn neg(self) -> Self::Output {
        match self {
            ...
            Primitive::Bool(_b) => Primitive::Error("call to neg() on a boolean value"),
            Primitive::Error(e) => panic!("call to div() on an error. {e}"),
        }
    }
}
...
impl  std::ops::Not for Primitive {
    ...
    fn not(self) -> Self::Output {
        match self {
            ...
            Primitive::Int(_) => Primitive::Error("call to not() on an int value"),
            Primitive::Double(_) => Primitive::Error("call to not() on a double value"),
            Primitive::Error(e) => panic!("call to div() on an error. {e}"),
        }
    }
}
